# Evidence pack: C005 Meridian Holdings Ltd
...
| Application hash | sha256 281cc1e192d6e8c8… |

## Why

- R-JUR-01 No prohibited jurisdiction: prohibited: XP
...
| Company age | 116 months | 0 | POL-4.4 |
| Expected monthly volume | USD 200,000 | 0 | POL-4.3 |
| **Total** | **low** | **15** |  |
...
| R-JUR-01 | No prohibited jurisdiction | FIRED | reject | POL-3.1 | prohibited: XP |
...
| R-VOL-01 | Expected volume under escalation threshold | pass |  | POL-4.3 | expected USD 200,000/month |
...
| Field | Value |
|---|---|
| Legal name | Meridian Holdings Ltd |
| Registration number | REG-005-2017 |
| Entity type | company |
| Incorporated | 2017-01-09 in XP |
| Operates in | XP |
| Sector | import_export |
| Expected monthly volume | USD 200,000 |

## Ownership

| Owner | Type | Ownership | ID verified | Nationality |
|---|---|---|---|---|
| Ivan Sokol | individual | 100% | yes | XP |
...
| Document | Dated |
|---|---|
| certificate_of_incorporation | 2017-01-09 |
